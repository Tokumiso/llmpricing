  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
      <div className="container mx-auto px-4 py-16 max-w-6xl">
              ...
              <table className="w-full">
                <thead className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-700">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-sm font-bold text-gray-900 dark:text-white">Visit</th>
                  </tr>
                </thead>
        ...
        <p className="mt-6 text-xs text-center text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
          Some links on this page may be affiliate links. We may earn a commission if you sign up through them, at no extra cost to you. See our{" "}
        ...
        <footer className="mt-20 text-center text-gray-500 dark:text-gray-400 text-sm space-y-4">
          ...
          <p>© 2026 LLM Pricing · Built with Next.js</p>
        </footer>
      </div>
    </main>
  );
